...
async function search() {
  ...
  await nightmare
    ...
    .type('input.el-input__inner', account) //輸入關鍵字
    .wait(1000) //等待數秒
    .type('div.el-input--suffix input.el-input__inner', pwd) //輸入關鍵字
    .wait(1000) //等待數秒
    .click('button.btn') //按下「地區」
    .wait(4000) //等待數秒
...
async function parseHtml() {
  ...
  $(html)
    ...
    .each((index, element) => {
      ...
      let positionLink =
        'https:' + elm.find('h2.b-tit a.js-job-link').attr('href');
